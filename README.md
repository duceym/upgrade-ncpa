...
The script is self-updating — `upgrade-ncpa.ps1` is included in the plugin list and will be copied to the client on every run, keeping it current automatically.
